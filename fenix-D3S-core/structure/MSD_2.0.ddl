...
CREATE PROPERTY DSD.cache EMBEDDED DSDCache;
...
CREATE PROPERTY DSDCache.manager STRING;
CREATE PROPERTY DSDCache.storage STRING;
...
CREATE PROPERTY Code.shortTitle EMBEDDEDMAP STRING;
CREATE PROPERTY Code.description EMBEDDEDMAP STRING;
CREATE PROPERTY Code.supplemental EMBEDDEDMAP STRING;
...
CREATE PROPERTY MeIdentification.parents LINKLIST MeIdentification;
...
CREATE PROPERTY MeIdentification.meDataQuality EMBEDDED MeDataQuality;
  ...
  CREATE PROPERTY MeDataQuality.seAccuracy EMBEDDED SeAccuracy;
    ...
    CREATE PROPERTY SeAccuracy.completeness EMBEDDEDMAP STRING;
