...
import org.fao.fenix.d3s.backup.dao.RestoreBackup;
import org.fao.fenix.d3s.backup.dao.RestoreBackupConsumer;
import org.fao.fenix.d3s.backup.dao.StoreBackup;
...
public class ManageBackup implements RestoreBackupConsumer {
    @Autowired
    StoreBackup backupStoreDao;
    @Autowired RestoreBackup backupRestoreDao;
    @Autowired
    CommonsLoad commonsLoadDao;
    @Autowired
    CodeListLoad codeListLoadDao;
    @Autowired
    DMLoad dmLoadDao;
    @Autowired
    CommonsStore commonsStoreDao;
    @Autowired
    CodeListStore codeListStoreDao;
    @Autowired
    DMStore dmStoreDao;
