...
public class OrientCache extends Cache {
    ...
    @Override
	public void storeData(ResourceFilter filter, Collection<ODocument> dataset, SearchStep value) throws Exception {
        cloneResult(value);
		// TODO Auto-generated method stub
	}

	@Override
	public void loadData(ResourceFilter filter, Collection<ODocument> dataset) throws Exception {
        data = null;
		// TODO Auto-generated method stub
	}
