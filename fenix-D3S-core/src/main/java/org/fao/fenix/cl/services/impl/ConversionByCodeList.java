...
import org.fao.fenix.cl.conversion.Converter;
import org.fao.fenix.cl.conversion.ConverterFactory;
...
public class ConversionByCodeList extends OrientDao {
	...
	@Autowired CodeListLinkLoad clLinkDao;
	@Autowired CodeListLoad clDao;
	@Autowired CodeListConverter clConverter;
