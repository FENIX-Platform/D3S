...
public class LoadDM extends Service implements org.fao.fenix.msd.services.spi.LoadDM {
	...
	public DM getDatasetMetadata(String uid, Boolean all) throws Exception {
        return getProxy(org.fao.fenix.msd.services.spi.LoadDM.class).getDatasetMetadata(uid, all);
	}
	@Override
	public Collection<DM> getDatasetMetadata(Boolean all) throws Exception {
        return getProxy(org.fao.fenix.msd.services.spi.LoadDM.class).getDatasetMetadata(all);
	}

    @Override
    public Collection<DM> getDatasetMetadataLike(String uid, Boolean all) throws Exception {
        return getProxy(org.fao.fenix.msd.services.spi.LoadDM.class).getDatasetMetadataLike(uid, all);
    }

    @Override
    public Collection<DM> getDatasetMetadata(String[] uids, Boolean all) throws Exception {
        return getProxy(org.fao.fenix.msd.services.spi.LoadDM.class).getDatasetMetadata(uids, all);
    }
    @Override
    public Collection<String> getDatasetMetadataEcho(String[] uids) throws Exception {
        return getProxy(org.fao.fenix.msd.services.spi.LoadDM.class).getDatasetMetadataEcho(uids);
    }

    @Override
    public Object getMetadataStructure(String uid, Boolean all) throws Exception {
        return getProxy(org.fao.fenix.msd.services.spi.LoadDM.class).getMetadataStructure(uid, all);
    }
